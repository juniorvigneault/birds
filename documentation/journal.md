...
## February 7th 2025 - Morning

- [X]  Make video pause when on it with mouse, and then detect the image only
- [X]  Make the bird images be on the video instead of always at the bottom
- [ ]  Add matter.js tool
