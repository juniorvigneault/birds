...
let img;
let pixelation_level = 40; // Adjust the pixelation level for larger pixels
let pixelsToAdd = [];
let fakeFaceImage;
let timeToDraw = 10;
...
function createBoundaries() {
  ...
  boundaries.push(
    new Boundary(
      leftWall.x - leftWall.w / 2,
      leftWall.y + leftWall.h / 2,
      leftWall.w,
      leftWall.h,
      0,
      world
  ...
  boundaries.push(
    new Boundary(
      ceiling.x + ceiling.w / 2,
      ceiling.y - ceiling.h / 2,
      ceiling.w,
      ceiling.h,
      0,
      world
